    ...
    if request.method == 'POST':
        try:
            ...
            if request.headers.get('HX-Request') == 'true':
                ...
                return render(request, 'calculator/fragments/wind_triangle_fragment.html', results)
            else:
                return JsonResponse({'success': True, 'results': results})
        except (ValueError, TypeError, ZeroDivisionError) as e:
            if request.headers.get('HX-Request') == 'true':
                return render(request, 'calculator/fragments/wind_triangle_fragment.html', {'drift_angle': '-', 'magnetic_heading': '-', 'ground_speed': '-', 'error': str(e)})
            else:
...
def great_circle(request):
    ...
    if request.method == 'POST':
        try:
            ...
            if request.headers.get('HX-Request') == 'true':
                return render(request, 'calculator/fragments/great_circle_fragment.html', results)
            else:
                return JsonResponse({'success': True, 'results': results})
        except (ValueError, TypeError) as e:
            if request.headers.get('HX-Request') == 'true':
                return render(request, 'calculator/fragments/great_circle_fragment.html', {'distance': '-', 'initial_bearing': '-', 'error': str(e)})
            else:
                return JsonResponse({'success': False, 'error': str(e)})
...
def rhumb_line(request):
    ...
    if request.method == 'POST':
        try:
            ...
            if request.headers.get('HX-Request') == 'true':
                return render(request, 'calculator/fragments/rhumb_line_fragment.html', results)
            else:
                return JsonResponse({'success': True, 'results': results})
        except (ValueError, TypeError) as e:
            if request.headers.get('HX-Request') == 'true':
                return render(request, 'calculator/fragments/rhumb_line_fragment.html', {'distance': '-', 'bearing': '-', 'error': str(e)})
            else:
                return JsonResponse({'success': False, 'error': str(e)})
